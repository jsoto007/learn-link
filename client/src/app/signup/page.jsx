      ...
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-md">
            {/* <img
              ...
              alt="Your Company"
            /> */}
            <h2 className="mb-6 text-center text-4xl font-normal leading-9 tracking-tight text-gray-900">
              Hello there 👋
            </h2>
            <p className='text-center'>Please enter your email and password to create an account.</p>
          </div>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      name="password"
                      type="password"
                      placeholder='Your secret key to enter'
